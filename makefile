...
reviiot: bin/Card.o bin/Hand.o bin/Deck.o bin/Player.o bin/Game.o bin/reviiyot.o
	$(CC) -o bin/reviiot bin/Card.o bin/Hand.o bin/Deck.o bin/Player.o  bin/Game.o bin/reviiyot.o $(LFLAGS)
